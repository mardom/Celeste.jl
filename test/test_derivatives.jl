...
function test_beta_kl_derivatives()
    ...
    beta_kl = DeterministicVI.gen_beta_kl(alpha2, beta2)
...
function test_categorical_kl_derivatives()
    ...
    categorical_kl = DeterministicVI.gen_categorical_kl(p2)
...
function test_normal_kl_derivatives()
    ...
    normal_kl = DeterministicVI.gen_normal_kl(mean2, var2)
